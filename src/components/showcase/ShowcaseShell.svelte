...
>
	...
	<!-- Phones: the board sits at the top of the screen, spare height goes below the rail. md+: the
	     table is centred in the viewport. -->
	<main
		class="flex-grow w-full max-w-5xl mx-auto px-3 sm:px-4 md:px-6 py-2 sm:py-6 flex flex-col justify-start md:justify-center"
	>
